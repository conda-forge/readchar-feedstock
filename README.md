...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/readchar-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=9098&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/readchar-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `readchar` can be installed with:

```
conda install readchar
```

It is possible to list all of the versions of `readchar` available on your platform with:
